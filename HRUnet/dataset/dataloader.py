...
class HRUnetDataLoader(DataLoader):
    def __init__(self,
                 data: Blosc2Reader,
                 batch_size: int,
        ...
        self.annotated_classes_key = tuple([-1] + data.labels)
        self.has_ignore = data.has_ignore_label
...
#dl = HRUnetDataLoader(data, 2, (128, 128, 128), (128, 128, 128), 0.33, None, None)
#a = next(dl)